...
class WconceptPreprocess:
    ...
    def get_product_and_product_info_list(self, tasks):
        product_list = []
        product_info_list = []
...
class WconceptReviewPreprocess:
    ...
    def get_product_detail(self, index, soup):
        try:
    ...
    def get_review_data(self, index, soup, product_id):
        # 구매 옵션과 사이즈정보 빼내기 용
        ...
        # 사이즈, 색상, 소재 빼내기 용
        size, color, texture, sku = self.get_product_detail(index, soup)
