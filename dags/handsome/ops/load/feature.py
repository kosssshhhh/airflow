...
class LoadHandsomeFeature(BaseOperator):
    ...
    def transform_data(self, xcom_data, cdn_image_urls):
        ...
        for style_id, urls in cdn_image_urls.items():
            ...
            small_category = style_info.get("smallCategory", default_category)
            embeddings = self.call_embedding_api(urls, [small_category] * len(urls))
